  ...
  template: `
    <div class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-sm">
      ...
      <div class="w-full max-w-sm mx-4 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <!-- Header -->
        <div class="flex flex-col items-center pt-8 pb-6 px-8 bg-gradient-to-b from-orange-50/40 to-white">
          <img src="/logo-bus.png" alt="Flota La Macarena" class="h-20 w-auto object-contain mb-3 drop-shadow-md" />
